...
scp /data/github/ordx/ordx-testnet root@192.168.1.101:/usr/bin/ordx-testnet4-master
...
scp /data/github/ordx/ordx-testnet root@192.168.1.101:/usr/bin/ordx-testnet4-slave
