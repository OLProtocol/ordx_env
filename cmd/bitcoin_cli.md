```shell
bitcoin-cli -rpcwallet=ord -chain=regtest -rpcuser=jacky -rpcpassword=123456 -rpcport=18443 createwallet test
bitcoin-cli -rpcwallet=ord -rpcuser=jacky -rpcpassword=123456 -rpcport=18443 getwalletinfo
