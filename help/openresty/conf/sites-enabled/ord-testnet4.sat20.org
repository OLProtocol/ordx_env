server {
    server_name ord-testnet4.sat20.org; # managed by Certbot
    ...
    location ~ ^/(content/|preview/|r/blockhash/|r/blockinfo/|r/inscription/|r/metadata/)(.*)$ {
        ...
        proxy_pass http://prd_testnet4;
        rewrite ^/(content/|preview/|r/blockhash/|r/blockinfo/|r/inscription/|r/metadata/)(.*)$ /testnet4/ord/$1$2 break;
